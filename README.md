...
* **Generador de Contenido Audiovisual**: Proyecto integrado de [Remotion](file:///home/huaritex/Desktop/Proyectos_Desarrollo/Hackthon_2026/video/package.json) para compilar y generar videos promocionales en alta definición (1080p @ 60fps) mediante código en React.
...
* **Interacción Inmersiva en la Landing**: La página principal implementa un sistema interactivo en 3D impulsado por [GLManager.ts](file:///home/huaritex/Desktop/Proyectos_Desarrollo/Hackthon_2026/src/gl/GLManager.ts) y [HeroSection.tsx](file:///home/huaritex/Desktop/Proyectos_Desarrollo/Hackthon_2026/src/components/sections/HeroSection.tsx). A medida que el usuario hace scroll, las piezas del robot (`cuerpo.stl` y `tapa.stl`) se ensamblan y escalan dinámicamente frente a sus ojos, vendiendo la idea visualmente de forma inmediata.
...
* **Motor de Marketing Integrado**: La subcarpeta [/video/](file:///home/huaritex/Desktop/Proyectos_Desarrollo/Hackthon_2026/video) contiene un generador automático de anuncios publicitarios en Remotion. Al configurar una clave de ElevenLabs, el proyecto compila un video comercial personalizado con voz realista y gráficos sincronizados automáticamente mediante código, simplificando la distribución del producto.
